...
void main(void){
  ...
  if(UV.x<100){     //Amount / Density of particles. If you change this and want to keep system in middle then adapt 50 in line 93 below with half of this number
    ...
    p.z-=50*tubeLength; //Move tube in middle, 50 is simply half of the amount of particles. Yes if you change 100 on line 87 you should change 50 to half of it
